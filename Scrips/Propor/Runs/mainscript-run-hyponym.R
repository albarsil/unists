...
# Load synonim
require(data.table)
sentences_train <- fread("Data/Propor/assin-ptbr-train-hyponomy.csv", header = TRUE, sep = ";", encoding = "UTF-8")
sentences_test <- fread("Data/Propor/assin-ptbr-test-hyponomy.csv", header = TRUE, sep = ";", encoding = "UTF-8")
...
write.table(clearRunResults, "Results/clear-run-results-hyponym.csv", sep = ";", quote = TRUE, fileEncoding = "UTF-8")