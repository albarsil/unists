...
# library(readr)
# library(jsonlite)
# write_lines(toJSON(data.train), "Datasets/mainscript-run-synonim-train.json")
# write_lines(toJSON(data.test), "Datasets/mainscript-run-synonim-test.json")

library(readr)
library(jsonlite)

data.train <- fromJSON(read_lines("Datasets/Datasets/mainscript-run-synonim-train.json"))
data.test <- fromJSON(read_lines("Datasets/Datasets/mainscript-run-synonim-test.json"))
...
write.table(clearRunResults, "Results/glm-run-results-synonim.csv", sep = ";", quote = TRUE, fileEncoding = "UTF-8")