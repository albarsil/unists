...
clearRunResults <- experiment.svm(data.train, data.test, 1:ncol(data.train))
write.table(clearRunResults, "Results/svm-run-results-clear.csv", sep = ";", quote = TRUE, fileEncoding = "UTF-8", append = FALSE)